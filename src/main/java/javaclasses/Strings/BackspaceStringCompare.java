...
/*Backspace String Compare. Given two strings S and T, we have to write a code to check
if they are equal when both are typed into empty text editors.  In string # means a backspace character.
