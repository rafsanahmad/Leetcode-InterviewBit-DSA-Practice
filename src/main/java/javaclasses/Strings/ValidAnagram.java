...
only the order of characters in both the strings is different. In other words, both strings must contain the
same exact letters in the same exact frequency.
...
count of the second string. Finally, we check if the character count is zero. If it is not zero(0) then the
