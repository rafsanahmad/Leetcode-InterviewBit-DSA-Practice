/*
 * *
 *  * Knap Sack Problem.java
 *  * Created by Rafsan Ahmad on 1/25/22, 9:01 PM
...
Here’s the general way the problem is explained – Consider a thief gets into a home to rob and he carries a knapsack.
 There are fixed number of items in the home – each with its own weight and value – Jewellery, with less weight and
 highest value vs tables, with less value but a lot heavy. To add fuel to the fire, the thief has an old knapsack
 which has limited capacity. Obviously, he can’t split the table into half or jewellery into 3/4ths.
...
A cursory look at the example data tells us that the max value that we could accommodate with the limit of max weight
 of 10 is 50 + 40 = 90 with a weight of 7.*/
        ...
        for (int item = 1; item <= N; item++) {
            ...
            for (int weight = 1; weight <= W; weight++) {
                ...
                if (wt[item - 1] <= weight) {
                    ...
                    // running weight, just carry forward the value without the current item
