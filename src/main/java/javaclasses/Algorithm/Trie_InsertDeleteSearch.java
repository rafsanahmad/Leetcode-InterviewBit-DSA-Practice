/*
 * *
 *  * Trie_InsertDeleteSearch.java
 *  * Created by Rafsan Ahmad on 7/3/22, 1:36 PM
 ...
 **/
public class Trie_InsertDeleteSearch {
    ...
    public Trie_InsertDeleteSearch() {
        root = new TrieNode();
    }
    ...
    public static void main(String[] args) {
        Trie_InsertDeleteSearch trie = new Trie_InsertDeleteSearch();
        trie.insert("abc");
        trie.insert("abgl");
        trie.insert("cdf");
        trie.insert("abcd");
        ...
        System.out.println(trie.search("abgl")); //true
