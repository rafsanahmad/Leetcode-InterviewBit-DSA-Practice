/*
 * *
 *  * Segment Tree Minimum Range Query.java
 *  * Created by Rafsan Ahmad on 10/25/23, 2:00 AM
...
import javaclasses.BitManipulation.NextPowerOf2;
/**
...
public class SegmentTreeMinimumRangeQuery {
     ...
     */
    public void updateSegmentTreeRange(int input[], int segmentTree[], int startRange,
                                       int endRange, int delta) {
     ...
     */
    public void updateSegmentTreeRangeLazy(int input[], int segmentTree[], int lazy[], int startRange,
                                           int endRange, int delta) {
    ...
    private void updateSegmentTreeRange(int segmentTree[], int startRange, int endRange,
    ...
    private void updateSegmentTreeRangeLazy(int segmentTree[], int lazy[], int startRange,
