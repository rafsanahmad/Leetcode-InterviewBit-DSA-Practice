 ...
 * *
 *  * Jump Game II.kt
 *  * Created by Rafsan Ahmad on 7/5/25, 7:01PM
...
It's guaranteed that you can reach nums[n - 1].*/
    ...
    /*Concept Intuition
farthest: the farthest index you can reach from the current segment.
currentEnd: the end of the current jump range.
i == currentEnd means: we've reached the end of the current jump, and now we need to jump
again.*/
...
fun main() {
    val obj = JumpGameII()
    println(obj.jump(intArrayOf(2, 3, 1, 1, 4)))
}
